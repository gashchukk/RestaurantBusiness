...
def create_employee(*, db: Session = Depends(get_db), user_in: UserCreate) -> Any:
    """ Create new employee """
...
def read_employees( db: Session = Depends(get_db), skip: int = 0, limit: int = 100,) -> Any:
    """ Retrieve employees """
...
def update_user_me(*, db: Session = Depends(get_db), user_in: UserUpdate,
